...
var animationFrameRequest = animationFrame.request
...
Motion.prototype.run = function () {
    ...
    self.isRuning = true
    animationFrameRequest(function action () {
        if (!self.isRuning) {
            return
        }
        ...
        // 修复 elapsedTime actionTime 因为 animationFrameRequest 不是精准控制时间
